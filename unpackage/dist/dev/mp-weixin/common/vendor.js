...
/* 4 */
/*!***************************************************************!*\
  !*** D:/preproject/mypreproject/zlbeanh5/zlbeanh5/pages.json ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 7 */
/*!********************************************************************************!*\
  !*** D:/preproject/mypreproject/zlbeanh5/zlbeanh5/pages.json?{"type":"style"} ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationStyle": "custom" }, "pages/login/login": {} }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "区外扫码活动", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),
/* 8 */
/*!*******************************************************************************!*\
  !*** D:/preproject/mypreproject/zlbeanh5/zlbeanh5/pages.json?{"type":"stat"} ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__E7FC5E1" };exports.default = _default;

/***/ }),
/* 9 */
/*!*******************************************************************!*\
  !*** D:/preproject/mypreproject/zlbeanh5/zlbeanh5/store/index.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 17 */
/*!***************************************************************************!*\
  !*** D:/preproject/mypreproject/zlbeanh5/zlbeanh5/common/utils/config.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; /**
                                                                                                      * 签名参数与后台参数一致
                                                                                                      */
var client = 'mini-program';
var version = '1.0';
var key = '512162086@561kiojdsy';
...
/**
                     * 开发服务器地址
                     */
var webUrl_dev = 'http://ld.haiyunzy.com/zlbean/';
var apiUrl_dev = 'http://ld.haiyunzy.com/zlbean/';
var loginUrl_dev = 'http://ld.haiyunzy.com/zlbean/frontpage/activity/index';
var hosturl_dev = 'http://ld.haiyunzy.com/zlbean/';
var imghosturl_dev = 'http://ld.haiyunzy.com/zlbean/';
var jssdkUrl_dev = 'http://ld.haiyunzy.com/zlbean/jsSdkConfig/getJsSdkConfig';

/**
                                                                                * 正式服务器地址
                                                                                */
var webUrl_pro = 'http://ld.thewm.cn/zlbean/';
var apiUrl_pro = 'http://ld.thewm.cn/zlbean/';
var loginUrl_pro = 'http://ld.thewm.cn/zlbean/frontpage/activity/index';
var hosturl_pro = 'http://ld.thewm.cn/zlbean/';
var imghosturl_pro = 'http://ld.thewm.cn/zlbean/';
var jssdkUrl_pro = 'http://ld.thewm.com/zlbean/jsSdkConfig/getJsSdkConfig';var _default =
...

{
  ...
  jssdkUrl: active === 'dev' ? jssdkUrl_dev : jssdkUrl_pro };exports.default = _default;

/***/ }),
/* 18 */
/*!*************************************************************************!*\
  !*** D:/preproject/mypreproject/zlbeanh5/zlbeanh5/common/utils/util.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
var _md = _interopRequireDefault(__webpack_require__(/*! @/common/utils/md5 */ 19));
var _config = _interopRequireDefault(__webpack_require__(/*! @/common/utils/config */ 17));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var formatDate = function formatDate(fmt, date) {
  var o = {
...
var signString = function signString(formData, now) {
  return (0, _md.default)(
  encodeURIComponent(formData + _config.default.key + now));
...
var formatDateString = function formatDateString(fmt, date) {
  date = date.replace(/-/g, "/");
  var time = new Date(date);
  return formatDate(fmt, time);
};

var getParam = function getParam(url, variable) {
...
/* 19 */
/*!************************************************************************!*\
  !*** D:/preproject/mypreproject/zlbeanh5/zlbeanh5/common/utils/md5.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 20 */
/*!**********************************************************************************!*\
  !*** D:/preproject/mypreproject/zlbeanh5/zlbeanh5/common/vmeitime-http/index.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = exports.scanIndex = exports.setDefaut = exports.addressDetail = exports.saveAddress = exports.addresslist = exports.getUserIno = void 0;var _interface = _interopRequireDefault(__webpack_require__(/*! ./interface */ 21));
var _config = _interopRequireDefault(__webpack_require__(/*! @/common/utils/config */ 17));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
// 获取用户信息
var getUserIno = function getUserIno() {
  return _interface.default.get('/user/user/get', { 'accessToken': uni.getStorageSync('accessToken') });
};
...
//我的地址列表
exports.getUserIno = getUserIno;var addresslist = function addresslist(data) {return _interface.default.get('/address!list.action', data);};
//添加/编辑地址
exports.addresslist = addresslist;var saveAddress = function saveAddress(data) {return _interface.default.post('/address!saveorUpdate.action', data);};
//获取详细地址并编辑
exports.saveAddress = saveAddress;var addressDetail = function addressDetail(data) {return _interface.default.get('/address!getDetail.action', data);};
// 设置默认地址
exports.addressDetail = addressDetail;var setDefaut = function setDefaut(data) {return _interface.default.get('/address!setDefaut.action', data);};



//##################扫码活动start#####
//扫码活动主页
exports.setDefaut = setDefaut;var scanIndex = function scanIndex(data) {return _interface.default.get('/api/scan/index', data);};

//###################扫码活动end#####
exports.scanIndex = scanIndex;var _default =


{
  scanIndex: scanIndex };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))

/***/ }),
/* 21 */
/*!**************************************************************************************!*\
  !*** D:/preproject/mypreproject/zlbeanh5/zlbeanh5/common/vmeitime-http/interface.js ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _config2 = _interopRequireDefault(__webpack_require__(/*! @/common/utils/config */ 17));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                       * 通用uni-app网络请求
                                                                                                                                                                       ...
                                                                                                                                                                       */ /*
                                                                                                                                                                          ...
                                                                                                                                                                          */var _default = { config: { baseUrl: _config2.default.apiUrl, header: { 'Content-Type': 'application/json;charset=UTF-8' //'Content-Type':'application/x-www-form-urlencoded'
    }, data: {}, method: "GET", dataType: "json", /* 如设为json，会对返回的数据做一次 JSON.parse */responseType: "text", success: function success() {}, fail: function fail() {}, complete: function complete() {} }, interceptor: { request: null, response: null }, request: function request(options) {var _this = this;if (options.showLoading) {uni.showLoading({ mask: true, title: '加载中...' });}if (!options) {options = {};}options.baseUrl = options.baseUrl || this.config.baseUrl;options.dataType = options.dataType || this.config.dataType;options.url = options.baseUrl + options.url;
    ...
    var now = _util.default.formatDate('yyyyMMddHHmmss', new Date());
    ...
    return new Promise(function (resolve, reject) {
      ...
      options.complete = function (response) {
        ...
        if ( true && _config2.default.debug) {
          if (statusCode === 200) {
...
/* 22 */
/*!***************************************************************************!*\
  !*** D:/preproject/mypreproject/zlbeanh5/zlbeanh5/common/utils/wechat.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _config = _interopRequireDefault(__webpack_require__(/*! @/common/utils/config */ 17));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 微信jssdk 工具类
var jweixin = __webpack_require__(/*! @/components/jweixin-module/lib/index.js */ 23); // import jweixin from '@/components/jweixin-module/lib/index';
var _default = { //判断是否在微信中  
  ...
  initJssdkShare: function initJssdkShare(callback, url) {
    ...
    uni.request({
      url: _config.default.jssdkUrl, //获取jssdk地址
      data: {
        url: url },
      ...
      success: function success(res) {
        console.log("jssdk==" + JSON.stringify(res));
...
/* 23 */
/*!*******************************************************************************************!*\
  !*** D:/preproject/mypreproject/zlbeanh5/zlbeanh5/components/jweixin-module/lib/index.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
